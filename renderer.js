...
ws.onmessage = (event) => {
    ...
    if(data.type === 'history') {
        ...
        roomDiv.className = 'room-item selected';
        roomDiv.textContent = `🚪 ${roomName}`;
        
        // **[แก้ไข]** 2. เพิ่ม Event Listener ให้แท็บห้องสามารถถูกคลิกได้
        roomDiv.addEventListener('click', () => {
            // เมื่อคลิกแท็บห้อง ให้โหลดประวัติแชทของห้องนั้นอีกครั้ง
            // ส่งรหัสเป็นว่าง ('') Server จะใช้รหัสที่เคยบันทึกไว้ใน rooms[roomName].password
